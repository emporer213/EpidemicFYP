...
class ContinuousSpace:
    ...
    def get_nearest_station(self, pos, radius):
        ...
        idxs, = np.where(dists <= radius ** 2)
        neighbors = [self._index_to_station[x] for x in idxs if include_center or dists[x] > 0]
        distance_list = []
        if len(neighbors) == 1:
            return neighbors[0]
        ...
        if neighbors is not None:
            ...
            return dis_shortest[0]
        radius =+ 1

        get_nearest_station(pos, radius)
